...
| 4 | Состояние и сохранение (Context, reducer, localStorage, restore) | [phase-4-5-game-engine.md](2026-07-03-phase-4-5-game-engine.md) | ✅ детализирован (объединён с Фазой 5) | 3 |
| 5 | Доп. механики (заметки, undo, таймер, сложность, жизни) | [phase-4-5-game-engine.md](2026-07-03-phase-4-5-game-engine.md) | ✅ детализирован (объединён с Фазой 4) | 4 |
